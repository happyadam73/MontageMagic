//
//  AWBCollageSettingsTableViewController.m
//  Collage Maker
//
...
@implementation AWBCollageSettingsTableViewController
...
- (void)tableView:(UITableView *)aTableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (settingsGroup.isMutuallyExclusive) {
        ...
        if (setting.controlType == AWBSettingControlTypeDrilldown) {
            AWBCollageSettingsTableViewController *settingsController = [[AWBCollageSettingsTableViewController alloc] initWithSettings:setting.childSettings settingsInfo:[self settingsInfo] rootController:self]; 
...
- (void)finishSettingsWithInfo:(id)sender
{
    ...
    if([delegate respondsToSelector:@selector(awbCollageSettingsTableViewController:didFinishSettingsWithInfo:)]) {
		[delegate performSelector:@selector(awbCollageSettingsTableViewController:didFinishSettingsWithInfo:) withObject:self withObject:self.settingsInfo];
	}    
}
...
{
    [[self parentViewController] dismissModalViewControllerAnimated:YES];
    if([delegate respondsToSelector:@selector(awbCollageSettingsTableViewControllerDidDissmiss:)]) {
		[delegate performSelector:@selector(awbCollageSettingsTableViewControllerDidDissmiss:) withObject:self withObject:nil];
	}   
}
